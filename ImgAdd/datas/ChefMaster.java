...
public class ChefMaster {
    ...
    public ChefMaster(User user) {
        this.user = user;
        frame = new JFrame("CHEF MASTER");
        ...
        String[] foodNames = {"Morog Polao", "Beef Tehari", "Beef Khichuri", "Mutton Kachhi", "Chicken Roast", "Plain Polao"};
        double[] prices = {5.9, 7.7, 6.3, 8.8, 3.1, 1.5};
